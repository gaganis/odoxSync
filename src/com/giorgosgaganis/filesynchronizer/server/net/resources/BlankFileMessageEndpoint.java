...
@Path("blankfilemessage")
public class BlankFileMessageEndpoint {

    @POST
    @Produces(MediaType.APPLICATION_JSON)
    public Integer getIt(BlankFileMessage blankFileMessage) {
        try {
            DirectorySynchronizer.INSTANCE.addBlankFile(blankFileMessage);
            return 0;
        } catch (Exception e) {
            e.printStackTrace();
            return 1;
