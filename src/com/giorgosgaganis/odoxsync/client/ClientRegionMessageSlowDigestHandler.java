 ...
 */
public class ClientRegionMessageSlowDigestHandler implements SlowDigestHandler {

    private final int clientId;
    private final ClientMessageHandler clientMessageHandler;

    public ClientRegionMessageSlowDigestHandler(int clientId, ClientMessageHandler clientMessageHandler) {
    ...
    public void handleSlowDigest(File file, Region currentRegion, FileTime batchLastModifiedTime, byte[] slowDigest) {
        try {
            clientMessageHandler.submitSlowDigest(clientId, file.getId(), currentRegion.getOffset(), slowDigest);
